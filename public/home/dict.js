...
const comp3 = new dictComp(
    ...
    "For short term goals, I am hyper focused these on three goals: <br /><br /><b>(1)</b> Get a CO-OP internship to get hands-on experience in the field and solidify my current engineering skillset. </br /><b>(2)</b> Develop new technical and soft skills while working on improving the electrical design and documentation of the Agrobot (ubc design team project)<br /><b>(3)</b> Transform the engineering student center’s garden unkept and weed filled beds into a botanical paradise before I graduate!"],
    [["p14.webp", ""]]
)
