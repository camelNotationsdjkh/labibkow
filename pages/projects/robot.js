...
"/>
                <p>The main loop of the code on the controller is responsible for reading the user's input. First checking if the joystick has been pressed, and switching states if it has. If the current state is beacon mode, the delay between pulses is set to zero, otherwise the pulse delay is set based on the ADC readings of the two pins connected to the potentiometer. </p>
